...
& $compiler /nologo /target:winexe /optimize+ /out:dist\ice-optimizer.exe /win32manifest:src\app.manifest /resource:catalog.json,catalog.json /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Net.Http.dll /reference:System.Web.Extensions.dll src\Program.cs
