...
& $compiler /nologo /target:winexe /optimize+ /out:dist\ice-optimizer.exe /win32manifest:src\app.manifest /win32icon:assets\ice.ico /resource:assets\ice.ico,ice.ico /resource:assets\login-reference.jpg,login-reference.jpg /resource:catalog.json,catalog.json /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Net.Http.dll /reference:System.Web.Extensions.dll /reference:System.Security.dll /reference:System.Management.dll src\*.cs
