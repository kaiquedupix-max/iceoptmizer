...
fs.writeFileSync('catalog.json',JSON.stringify({name:'ice optimizer',author:'Maciota',version:'1.0.0',repository:'kaiquedupix-max/iceoptmizer',ref:'main',actions,files},null,2));
