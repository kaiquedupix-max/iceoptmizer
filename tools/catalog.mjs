...
fs.writeFileSync('catalog.json',JSON.stringify({name:'ice optimizer',author:'Ice Optimizer',version:'3.0.2',repository:'kaiquedupix-max/iceoptmizer',ref:'main',licenseApi:'https://ice-optimizer-web-production.up.railway.app',actions:enrich(actions),files},null,2));
