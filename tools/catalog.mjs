...
fs.writeFileSync('catalog.json',JSON.stringify({name:'ice optimizer',author:'Maciota',version:'2.5.0',repository:'kaiquedupix-max/iceoptmizer',ref:'main',licenseApi:'https://ice-optimizer-web-production.up.railway.app',actions:enrich(actions),files},null,2));
