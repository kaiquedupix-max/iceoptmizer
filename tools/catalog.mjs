...
const activations=new Set(['reverteramdintelnvidia','reverterxbox','ativarmemoria','ativarsuper','voltarforeground','reverterdebloater','opcao26']);
const duplicates=new Set(['opcao30','priorizar_re9','priorizar_marvel']);
...
fs.writeFileSync('catalog.json',JSON.stringify({name:'ice optimizer',author:'Ice Optimizer',version:'3.0.3',repository:'kaiquedupix-max/iceoptmizer',ref:'main',licenseApi:'https://ice-optimizer-web-production.up.railway.app',actions:enrich(actions),files},null,2));
