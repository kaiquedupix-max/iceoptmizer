...
fs.writeFileSync('catalog.json',JSON.stringify({name:'ice optimizer',author:'Maciota',version:'2.0.0',repository:'kaiquedupix-max/iceoptmizer',ref:'main',actions:enrich(actions),files},null,2));
